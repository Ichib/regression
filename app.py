...
pytorch_model_mlr.load_state_dict(
    torch.load('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/model/pytorch_iris_mlr_model.pkl')
)
...
scaler_mlr = joblib.load('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/model/scaler_mlr_model.pkl')
...
pytorch_model_binary.load_state_dict(
    torch.load('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/model/pytorch_iris_binary_lgr_model.pkl')
)
pytorch_model_binary.eval()
sklearn_model_binary = joblib.load('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/model/sklearn_iris_binary_lgr_model.pkl')
scaler_binary = joblib.load('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/model/scaler_binary_lgr_model.pkl')
...
pytorch_model_penguins.load_state_dict(
    torch.load('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/model/pytorch_penguins_model.pkl')
)
pytorch_model_penguins.eval()
sklearn_model_penguins = joblib.load('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/model/sklearn_penguins_model.pkl')
scaler_penguins = joblib.load('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/model/scaler_penguins_model.pkl')
...
pytorch_model_mpg.load_state_dict(
    torch.load('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/model/pytorch_mpg_model.pkl')
)
pytorch_model_mpg.eval()
sklearn_model_mpg = joblib.load('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/model/sklearn_mpg_model.pkl')
scaler_mpg = joblib.load('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/model/scaler_mpg_model.pkl')
...
if problem_choice == '🌸 Petal Width Prediction':
    ...
    if st.button('Predict'):
        ...
        if species[prediction] == 'Adelie':
            ...
            st.image('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/img/adelie_pen.jpeg', width=500)
        elif species[prediction] == 'Chinstrap':
            st.write(f'🐧 The penguin is predicted to be: {species[prediction]}')
            st.image('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/img/chinstrap_pen.jpeg', width=500)
        else:
            st.write(f'🐧 The penguin is predicted to be: {species[prediction]}')
            st.image('/Users/mac/Desktop/Home/Year 5/NLP/NLP-Project/src/P1/PDS-Regression/img/gentoo_pen.jpeg', width=500)
